...
para INL=1e-2, p=100 (data_beta_grid_search_SP/beta_grid_search_SP_INL_1e-2_p_100/),
...
SERIE = 0
BETA_OPTIMO_EMPIRICO = 350.0  # resumen_por_INL/resumen_optimos.csv: INL=1e-2, p=100
BETAS_REPRESENTATIVOS = [1.0, 50.0, 100.0, 200.0, 300.0, 350.0, 800.0, 1950.0]
TITULO_CURVA = "INL=1e-2, p=100"
