...
para INL=1e-2, p=50 (data_beta_grid_search_SP/beta_grid_search_SP_INL_1e-2_p_50/),
...
CARPETA = os.path.join(REPO_ROOT, "data_beta_grid_search_SP", "beta_grid_search_SP_INL_1e-2_p_50")
SERIE = 0
BETA_OPTIMO_EMPIRICO = 250.0  # resumen_por_INL/resumen_optimos.csv: INL=1e-2, p=50
BETAS_REPRESENTATIVOS = [1.0, 50.0, 100.0, 200.0, 250.0, 300.0, 800.0, 1950.0]
TITULO_CURVA = "INL=1e-2, p=50"
