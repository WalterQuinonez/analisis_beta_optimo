...
para INL=2e-1, p=100 (data_beta_grid_search_SP/beta_grid_search_SP_INL_2e-1_p_100/),
para cada uno de los 40 valores de beta de la grilla.

Version "hermana" de analisis_distribucion_softmax_INL_2e-1_p_50/ (mismo
metodo exacto), para poder comparar contra p=100 si el patron
...
CARPETA = os.path.join(REPO_ROOT, "data_beta_grid_search_SP", "beta_grid_search_SP_INL_2e-1_p_100")
SERIE = 0
BETA_OPTIMO_EMPIRICO = 100.0  # resumen_por_INL/resumen_optimos.csv: INL=2e-1, p=100
BETAS_REPRESENTATIVOS = [1.0, 50.0, 100.0, 200.0, 300.0, 800.0, 1950.0]
TITULO_CURVA = "INL=2e-1, p=100"
